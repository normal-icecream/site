  ...
  async fetch(request, env) {
    ...
    if (isOrderRequest && request.method === "POST") {
      if (isSandboxUrl) {
        ...
        if (locationParam) {
          const location = LOCATIONS.find((location2) => location2.name === locationParam.toUpperCase()).id;
...
// .wrangler/tmp/bundle-62VAAO/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-62VAAO/middleware-loader.entry.ts
